...
being used at Institute for Systems Biology where SLIMseq was developed.
...
Edit /apps/slimseq/config/application.yml to specify the location of your RubyCAS 
...
If all is well, you should be able to browse to <Server IP>:3000 and log in as a user that will 
authenticate on your RubyCAS-server. The first user to log in will automatically become an admin.
