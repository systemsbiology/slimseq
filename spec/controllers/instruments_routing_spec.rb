...
describe InstrumentsController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "instruments", :action => "update", :id => "1").
        should == {:path => "/instruments/1", :method => :put}
    end
  
    it "should map #destroy" do
      route_for(:controller => "instruments", :action => "destroy", :id => "1").
        should == {:path => "/instruments/1", :method => :delete}
    end
  end
