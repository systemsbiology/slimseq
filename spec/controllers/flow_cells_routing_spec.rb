...
describe FlowCellsController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "flow_cells", :action => "update", :id => "1").
        should == {:path => "/flow_cells/1", :method => :put}
    end
  
    it "should map #destroy" do
      route_for(:controller => "flow_cells", :action => "destroy", :id => "1").
        should == {:path => "/flow_cells/1", :method => :delete}
    end
  end
